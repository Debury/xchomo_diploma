...
NOTE: Legacy jobs (daily_etl_job, embedding_job, complete_pipeline_job, validation_job)
are commented out because they depend on old ops that no longer exist.
Use dynamic_source_etl_job from dynamic_jobs.py instead.
"""

from dagster import job

from dagster_project.resources import ConfigLoaderResource, LoggerResource, DataPathResource
# Legacy imports - commented out (ops don't exist anymore)
...
# ====================================================================================
# LEGACY JOBS - COMMENTED OUT
# ====================================================================================
# These jobs depend on ops that no longer exist (data_acquisition_ops, transformation_ops).
# Use dynamic_source_etl_job from dynamic_jobs.py instead.
